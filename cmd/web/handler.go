...
func (app *Config) LoginPage(w http.ResponseWriter, r *http.Request) {
	app.renderer(w, r, "login.page.gohtml", nil)
}
...
func (app *Config) RegisterPage(w http.ResponseWriter, r *http.Request) {
	app.renderer(w, r, "register.page.gohtml", nil)
}
...
func (app *Config) ChooseSubscription(w http.ResponseWriter, r *http.Request) {
	if !app.Session.Exists(r.Context(), "userID") {
		app.Session.Put(r.Context(), "warning", "you must be logged in to view this page.")
	...
	dataMap["plans"] = plans
	app.renderer(w, r, "plans.page.gohtml", &TemplateData{
		Data: dataMap,
	})
}
...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", "cannot subscribe to plan!")
		http.Redirect(w, r, "/members/plans", http.StatusSeeOther)
		return
	}
	u, err := app.Models.User.GetOne(user.ID)
	if err != nil {
		app.Session.Put(r.Context(), "error", "cannot get user from DB!")
		http.Redirect(w, r, "/members/plans", http.StatusSeeOther)
		return
	}
